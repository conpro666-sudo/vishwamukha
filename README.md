Vishwamukha 🪔
Ten guardians. Eleven days. One darkness to purify.
A 2D arena brawler themed on Vinayaka Chaturthi, built with plainHTML, CSS and JavaScript.
...
Tools Used:
HTML5 Canvas, vanilla JavaScript, CSS· An AI coding assistant was used during development;all core systems were built to be understood and explained line byline.
